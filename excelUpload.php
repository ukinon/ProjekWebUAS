...
if (isset($_POST['submit'])) {
  ...
  $path = 'temp_data/' . $nama_file_baru;
  if (is_file('temp_data/' . $nama_file_baru))
    unlink('temp_data/' . $nama_file_baru);
  ...
  if ($ext == "xlsx") {
    move_uploaded_file($tmp_file, 'temp_data/'. $nama_file_baru);
    $reader = new \PhpOffice\PhpSpreadsheet\Reader\Xlsx();
    $spreadsheet = $reader->load('temp_data/' . $nama_file_baru);
